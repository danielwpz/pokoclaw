...
<p align="center">
  ...
  <a href="#什么是-pokoclaw">什么是 Pokoclaw</a> •
  <a href="#核心理念">核心理念</a> •
  <a href="#适合谁用">适合谁用</a> •
  <a href="#为什么是-pokoclaw">为什么是 Pokoclaw</a> •
  <a href="#有何不同">有何不同</a> •
  <a href="#产品取舍">产品取舍</a> •
  <a href="#技术架构">技术架构</a>
</p>
...
Pokoclaw 强调的不是“完全自动化”，而是**可操控的自动化**：
...
Pokoclaw 关注的是**真实世界里的无人值守任务**，而不是演示式自动化。
...
很多产品能跑任务。  
Pokoclaw 更在意：这些任务是否**可见、可控、可持续、可托付**。
